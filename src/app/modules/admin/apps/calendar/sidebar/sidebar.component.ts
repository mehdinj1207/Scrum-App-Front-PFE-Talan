import { Component, EventEmitter, OnDestroy, OnInit, Output, TemplateRef,ChangeDetectorRef, ViewChild, ViewContainerRef, ViewEncapsulation } from '@angular/core';
...
import { MeetService } from 'app/modules/admin/customdash/meet/meet.service';
...
export class CalendarSidebarComponent implements OnInit, OnDestroy
{
    ...
    //Oumaima
    getProjects(){
        this._meetService.projectsByUserInMeet().subscribe(
            data=>{
                this.projects=data;
