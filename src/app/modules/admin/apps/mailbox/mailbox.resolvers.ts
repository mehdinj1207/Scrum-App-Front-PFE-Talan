...
import { Feedback, Mail, MailFilter, MailFolder, MailLabel } from 'app/modules/admin/apps/mailbox/mailbox.types';
...
export class MailboxMailResolver implements Resolve<any>
{
    ...
    {
        return this._mailboxService.getFeedbackById(+route.paramMap.get('id'));
